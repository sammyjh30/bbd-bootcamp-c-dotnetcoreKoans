...
namespace DotNetCoreKoans.Koans
{
    ...
    public class AboutMethods : Koan
    {
        ...
        public void MethodsCanHaveAVariableNumberOfParametersInAnArray()
        {
            ...
            Assert.Equal(new object[] {"Cory", "Will", "Corey"}, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            Assert.Equal(new object[] {"Cory", "Will", "Corey"}, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }
